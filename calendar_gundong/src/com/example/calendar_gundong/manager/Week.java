...
public class Week extends RangeUnit {
	...
	public Week(@NonNull LocalDate date, @NonNull LocalDate today, @Nullable LocalDate minDate, @Nullable LocalDate maxDate) {
		super(date.withDayOfWeek(1), date.withDayOfWeek(7), "'week' w", today, minDate, maxDate);
