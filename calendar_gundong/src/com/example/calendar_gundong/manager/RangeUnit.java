...
public abstract class RangeUnit extends CalendarUnit {
	...
	protected RangeUnit(@NonNull LocalDate from, @NonNull LocalDate to, @NonNull String headerPattern, @NonNull LocalDate today, @Nullable LocalDate minDate, @Nullable LocalDate maxDate) {
