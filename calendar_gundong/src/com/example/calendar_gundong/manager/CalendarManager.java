...
public class CalendarManager {
	...
	public CalendarManager(@NonNull LocalDate selected, @NonNull State state, @Nullable LocalDate minDate, @Nullable LocalDate maxDate) {
	...
	public int getWeekOfMonth() {
		if (mUnit.isInView(mSelected)) {
			...
			return mUnit.getFirstWeek(mUnit.getFirstDateOfCurrentMonth(mActiveMonth)); // if
																						// not
																						// in
																						// this
																						// month
